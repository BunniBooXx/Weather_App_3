...
const Weather = () => {
  ...
  const search = async () => {
    ...
    let url = `http://api.openweathermap.org/data/2.5/weather?q=${element[0].value}&units=imperial&type=accurate&APPID=1541ac8480539da8b7701428c9ba2e9e`;
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="weather-location">New York City</div>
